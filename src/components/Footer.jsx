                ...
                <div className="container">
                    <div className="row">
                        <div className="col-md-3">
                            <h3>Brooklyn <br /> Cleaning Service</h3>
                            <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Quidem officiis eum quaerat quas fugit, repellendus aliquid.</p>
                        </div>
                        ...
                        <div className="col-md-3">
                            ...
                            <p>Brooklyn Cleaning Service <span>{new Date().getFullYear()}</span>. <br /> All rights reserved</p>
                        </div>
